...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='shop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscriptions_shops', to='shop.shop'),
        ),
        migrations.AddField(
            model_name='shop',
            name='subscription',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='shop_subscriptions', to='shop.subscription'),
        ),
        migrations.AddField(
            model_name='subscriptionhistory',
            name='shop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscriptions_shops_history', to='shop.shop'),
        ),
        migrations.AddField(
            model_name='subscriptionhistory',
            name='subscription',
